...
use warnings;
use Exporter 'import';
our @EXPORT_OK = qw(valid_legacy_name valid_uuid_name valid_snap_name valid_cloudinit_name valid_state_name valid_name get_images);
...
sub valid_name {
    valid_legacy_name $_[0] or valid_uuid_name $_[0] or valid_cloudinit_name $_[0] or valid_state_name $_[0]
}
